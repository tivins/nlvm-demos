...
├── src/*.nl    # sources
└── output.nlp  # compiled bundle (git-ignored, generated by nlc)
```
...
| [07_liskov](07_liskov/) | Liskov | Custom checked exceptions, compiler-enforced Liskov substitution via `throws`-clause covariance on method overrides (E016/E017) |
